...
import 'package:imdb/utlis/text.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: modified_text(text: 'Flutter Movie App ❤️', color: Colors.white, key: ValueKey(1), size: 25,),
          backgroundColor: Colors.transparent,
        ),
        body: ListView(
          children: [
            TV(tv: tv, key: ValueKey(1),),
            TrendingMovies(
              trending: trendingmovies, key: ValueKey(1),
            ),
            TopRatedMovies(
              toprated: topratedmovies, key: ValueKey(1),
            ),
          ],
        ));
  }
